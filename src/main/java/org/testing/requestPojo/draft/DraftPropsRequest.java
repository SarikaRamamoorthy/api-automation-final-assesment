...
public class DraftPropsRequest {
    ...
    private List<DraftPropsStockAvailability> stockAvailability;

    public List<DraftPropsStockAvailability> getStockAvailability() {
        return stockAvailability;
    }

    public void setStockAvailability(List<DraftPropsStockAvailability> stockAvailability) {
